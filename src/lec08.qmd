...
all with the same eigenvalues ({@thm-similar}). We can additionally find the
...
Note that due to rounding errors, that $A$ is not exactly equal to $Q R$ and $Q$ is not exactly orthormal.
